            ...
            if (val != null) {
                ...
                query.find().then(function (list) {
                    if (list[0] != null) {
                        ...
                        _this.headface = list[0]['headimage'];
                        console.log('here0+' + head);
...
var HeadfacePage = /** @class */ (function (_super) {
    ...
    function HeadfacePage(navCtrl, navParams, modalCtrl, storage, loadingCtrl, http, camera, transfer, file, filePath, actionSheetCtrl, toastCtrl) {
        var _this = _super.call(this) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.modalCtrl = modalCtrl;
    ...
    HeadfacePage.prototype.uploadImg = function () {
        ...
        var filename = objectId + "_avatar.jpg";
